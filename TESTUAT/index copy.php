        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h2 class="card-title">Areas of Concern wise Progress for current assessment</h2>
                        <?php
                    ...
                    <div class="card-body">
                        ...
                        ?>
                            ...
                            <div class="progress">
                                ...
                                <div class="progress-bar progress-bar-striped bg-success progress-bar-animated" role="progressbar" style="width: <?php echo round(($row['Obtained'] / $row['total']) * 100, 2) ?>%" aria-valuenow="<?php echo $row['Obtained']; ?>" aria-valuemin="0" aria-valuemax="<?php echo $row['total']; ?>"><?php echo $row['Obtained']  ?></div>
                            </div>
                        <?php }
                        mysqli_free_result($q2);
                        $con->next_result();
