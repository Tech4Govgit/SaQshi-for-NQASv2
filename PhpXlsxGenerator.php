...
class PhpXlsxGenerator
{
    ...
    {
        $this->subject = 'Score Card';
        $this->title = 'NQAS';
        $this->author = 'Piramal Swasthya Management & Research Institute';
        $this->company = 'Piramal Swasthya Management & Research Institute';
        $this->manager = 'Piramal Swasthya Management & Research Institute';
        $this->description = '';
        $this->keywords = '';
        $this->category = 'Report';
        $this->lastModifiedBy = 'Piramal Swasthya Management & Research Institute';
        $this->application = 'Piramal Swasthya Management & Research Institute';
...
{TYPES}
    ...
    protected function _write($fh)
    {
        ...
        $zipComments = 'Generated by ' . __CLASS__ . ' Piramal Swasthya Management & Research Institute';
        if (!$fh) {
            return false;
        }
